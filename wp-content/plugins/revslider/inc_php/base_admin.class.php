 ...
 class UniteBaseAdminClassRev extends UniteBaseClassRev{
		...
		public static function addCommonScripts(){
			...
			if(GlobalsRevSlider::$isNewVersion){	//load new jquery ui library
				...
				//Had to add this code to localise the jquery-ui. Need to look at bringing it into the theme files as opposed to the plugin.
                                $urlJqueryUI = plugins_url( '/revslider/js/jquery-ui.min.js');
